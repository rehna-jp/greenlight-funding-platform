    ...
    <div className="space-y-24 animate-fade-in">
      ...
      <section className="text-center py-20 space-y-8">
        ...
        <div className="flex flex-wrap gap-4 justify-center">
          <Link
            to="/projects"
            className="inline-flex items-center px-6 py-3 rounded-full bg-green-600 text-white font-medium text-lg transition-all hover:bg-green-700"
          >
            Explore Projects
          ...
          <Link
            to="/validate"
            className="inline-flex items-center px-6 py-3 rounded-full bg-white text-green-600 border-2 border-green-600 font-medium text-lg transition-all hover:bg-green-50"
          >
            Become a Validator
          </Link>
        </div>
      ...
      {/* Features Section */}
      <section className="py-20 bg-white rounded-3xl border border-green-100">
      ...
      <section className="text-center py-20">
        <div className="bg-green-50 rounded-3xl py-16 px-4">
          <h2 className="text-3xl font-bold text-black mb-4">
